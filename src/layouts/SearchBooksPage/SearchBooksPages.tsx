...
const SearchBooksPages = () => {
  ...
  const [categroySelection, setCategroySelection] = useState("Book category");
  ...
  const paginate = (pagNumber: number) => setCurrentPage(pagNumber);
